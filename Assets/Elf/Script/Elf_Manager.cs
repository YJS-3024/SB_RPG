...
public class Elf_Manager : MonoBehaviour {
	...
	[SerializeField] private Animation elfAnimation;
	...
	private void Awake()
	{
		if (elfAnimation == null && Elf != null)
		{
			elfAnimation = Elf.GetComponent<Animation>();
		}
	}

	private void PlayAnimation()
	{
		if (elfAnimation == null)
		{
			Debug.LogWarning("Elf_Manager requires an Animation component on Elf.", this);
			return;
		}

		elfAnimation.CrossFade(aniname[iani]);
	}
